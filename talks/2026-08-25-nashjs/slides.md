...
<div class="site-nav"><span class="site-name">agent-reference</span><span class="site-links"><span class="ver">v1.0.0-beta.2</span>&nbsp;&nbsp;&nbsp;github&nbsp;&nbsp;&nbsp;npm</span></div>
<div class="site-tag">Give your agents the source</div>
<div class="site-label">Let your agent set it up</div>
<div class="copyblock">
...
<div class="term"><div class="term-bar">agent</div><div class="term-body"><div class="sess"><div class="p">&gt; <span v-click.hide="1" class="caret">&#9612;</span><span v-click="1">Set this project up for agent-reference: run `npx agent-reference init` and follow the brief it prints.</span></div><div class="step" v-click="2"><div><span class="dot">&#9679;</span> Bash(npx agent-reference init)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;lockfile&nbsp;&nbsp;pnpm-lock.yaml, 412 dependencies</div><div class="r">&nbsp;&nbsp;&nbsp;&nbsp;transcript stores on this machine</div><div class="r">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;claude-code&nbsp;&nbsp;2,723 sessions&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;codex&nbsp;&nbsp;519&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;opencode&nbsp;&nbsp;147</div></div><div class="step" v-click="3"><div><span class="dot">&#9679;</span> Bash(rg -o '~/\S+|github\.com/\S+' ~/.claude/projects | sort | uniq -c | sort -rn)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;312 ~/code/acme/api&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;41 github.com/Effect-TS/website</div></div><div class="step" v-click="4"><div><span class="dot">&#9679;</span> Write(agent-reference.json)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;Wrote 13 lines to agent-reference.json</div><div><span class="dot">&#9679;</span> Write(agent-reference.local.json)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;Wrote 8 lines to agent-reference.local.json</div><div><span class="dot">&#9679;</span> Bash(agent-reference validate)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;ok: agent-reference.json and agent-reference.local.json define 3 references in 0 sets.</div></div><div class="step" v-click="5"><div class="s"><span class="dot">&#9679;</span> agent-reference is set up and the skill is installed. I declared the references you reach for most.</div></div></div></div></div>
...
<div class="term"><div class="term-bar">agent</div><div class="term-body"><div class="sess"><div class="p"><div>&gt; use effect to read the config file. handle it if the file isnt there, same as the api does</div></div><div class="step" v-click="1"><div><span class="dot">&#9679;</span> Skill(agent-reference)</div></div><div class="step" v-click="2"><div><span class="dot">&#9679;</span> Bash(agent-reference status)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;agent-reference.json (shared)</div><div class="r">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;effect&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;npm &middot; ready &middot; 4.0.0-rc.111 verified &middot; &hellip;/effect/6ba41e59c827</div><div class="r">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;effect-docs&nbsp;&nbsp;git &middot; ready &middot; &hellip;/website/6ee985b191a6</div><div class="r">&nbsp;&nbsp;&nbsp;&nbsp;agent-reference.local.json (this machine)</div><div class="r">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;api&nbsp;&nbsp;folder &middot; ready &middot; ~/code/acme/api</div></div><div class="step" v-click="3"><div><span class="dot">&#9679;</span> Bash(agent-reference get effect-docs)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;effect-docs -&gt; ~/.agent-reference/src/&hellip;/website/6ee985b191a6/&hellip;/docs/v4</div><div><span class="dot">&#9679;</span> Read(&hellip;/docs/v4/platform/file-system.mdx)</div></div><div class="step" v-click="4"><div><span class="dot">&#9679;</span> Bash(agent-reference get api)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;api -&gt; ~/code/acme/api</div><div><span class="dot">&#9679;</span> Read(~/code/acme/api/src/config.ts)</div></div><div class="step" v-click="5"><div><span class="dot">&#9679;</span> Update(src/config.ts)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;Updated src/config.ts with 9 additions</div><div class="add">&nbsp;&nbsp;&nbsp;&nbsp;12 +&nbsp;&nbsp;const fs = yield* FileSystem.FileSystem</div><div class="add">&nbsp;&nbsp;&nbsp;&nbsp;13 +&nbsp;&nbsp;return yield* fs.readFileString(CONFIG_PATH)</div></div></div></div></div>
...
<div class="trio">
<div class="panel"><div class="panel-head">agent-reference.json</div><div class="panel-body"><div class="code small"><div>{</div><div>&nbsp;&nbsp;<span class="k">"references"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"effect"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>:</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="s">"npm:effect@4.0.0-rc.111"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>:</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="s">"v4's own examples"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;},</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"pi"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>:</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="s">"github:earendil-works/pi"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>:</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="s">"A small coding agent"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;}</div><div>}</div></div></div></div>
<div class="panel"><div class="panel-head">~/.agent-reference/</div><div class="panel-body"><div class="code small"><div>git/</div><div>&nbsp;&nbsp;<span class="c"># bare mirrors,</span></div><div>&nbsp;&nbsp;<span class="c"># one per repository</span></div><div>&nbsp;&nbsp;github.com/</div><div>&nbsp;&nbsp;&nbsp;&nbsp;Effect-TS/effect.git</div><div>&nbsp;&nbsp;&nbsp;&nbsp;earendil-works/pi.git</div><div>&nbsp;</div><div>src/</div><div>&nbsp;&nbsp;<span class="c"># one worktree</span></div><div>&nbsp;&nbsp;<span class="c"># per commit</span></div><div>&nbsp;&nbsp;…/effect/6ba41e59c827/</div><div>&nbsp;&nbsp;…/pi/dcd461925db2/</div><div>&nbsp;</div><div>state/</div><div>&nbsp;&nbsp;<span class="c"># one file</span></div><div>&nbsp;&nbsp;<span class="c"># per project</span></div><div>&nbsp;&nbsp;web-a3f81c0426.json</div></div></div></div>
...
<div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;agent-reference.json (shared)</div>
<div class="r">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;effect&nbsp;&nbsp;npm &middot; ready</div>
<div class="r">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;pi&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;git &middot; ready</div>
<div class="r">&nbsp;</div>
<div><span class="dot">&#9679;</span> Bash(agent-reference get pi)</div>
<div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;pi -&gt; ~/.agent-reference/src/&hellip;</div>
<div class="r">&nbsp;&nbsp;&nbsp;/pi/dcd461925db2</div>
<div class="r">&nbsp;</div>
<div><span class="dot">&#9679;</span> Read(&hellip;/pi/dcd461925db2/src/&hellip;)</div>
</div></div></div>
</div>
...
<div class="panel"><div class="panel-head">agent</div><div class="panel-body"><div class="sess" style="font-size:12px"><div class="p"><div>&gt; copy codex's shell approval</div><div>&nbsp;&nbsp;flow into ours</div></div><div><span class="dot">&#9679;</span> Skill(agent-reference)</div><div><span class="dot">&#9679;</span> Bash(agent-reference get codex)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;codex -&gt; &hellip;/openai/codex/a4f10b27e83c</div><div><span class="dot">&#9679;</span> Grep(&quot;approval&quot;, &hellip;/codex-rs)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;23 matches</div><div><span class="dot">&#9679;</span> Read(&hellip;/core/src/safety.rs)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;Read 210 lines</div><div><span class="dot">&#9679;</span> Update(src/approval.ts)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;38 additions</div></div></div></div>
</div>
...
<div class="panel"><div class="panel-head">agent</div><div class="panel-body"><div class="sess" style="font-size:12px"><div class="p"><div>&gt; add streaming to the chat route</div></div><div><span class="dot">&#9679;</span> Skill(agent-reference)</div><div><span class="dot">&#9679;</span> Bash(agent-reference get ai)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;npm:ai@7.0.78 -&gt; &hellip;/vercel/ai/5b64c3901f7e</div><div><span class="dot">&#9679;</span> Read(&hellip;/generate-text/</div><div>&nbsp;&nbsp;&nbsp;&nbsp;stream-text.ts)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;Read 340 lines</div><div><span class="dot">&#9679;</span> Update(src/routes/chat.ts)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;22 additions, 4 removals</div></div></div></div>
</div>
...
<div class="pair">
<div class="panel"><div class="panel-head">agent-reference.json</div><div class="panel-body"><div class="code small"><div>{</div><div>&nbsp;&nbsp;<span class="k">"references"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"zod-v4"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"github:colinhacks/zod"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"ref"</span>: <span class="s">"v4.1.5"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"v4's API and its migration guide"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;},</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"zod-v3"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"github:colinhacks/zod"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"ref"</span>: <span class="s">"v3.22.0"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"v3's API, which this app calls"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;}</div><div>}</div></div></div></div>
<div class="panel"><div class="panel-head">agent</div><div class="panel-body"><div class="sess" style="font-size:12px"><div class="p"><div>&gt; migrate our user schema to zod 4</div></div><div><span class="dot">&#9679;</span> Skill(agent-reference)</div><div><span class="dot">&#9679;</span> Bash(agent-reference get zod-v3)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;zod-v3 -&gt; &hellip;/colinhacks/zod/ec2b5f1970ab</div><div><span class="dot">&#9679;</span> Bash(agent-reference get zod-v4)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;zod-v4 -&gt; &hellip;/colinhacks/zod/8f1c0a44d692</div><div><span class="dot">&#9679;</span> Read(&hellip;/zod/8f1c0a44d692/CHANGELOG.md)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;Read 1,204 lines</div><div><span class="dot">&#9679;</span> Update(src/schema/user.ts)</div><div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;17 additions, 17 removals</div><div class="del">&nbsp;&nbsp;&nbsp;8 -&nbsp;&nbsp;email: z.string().email()</div><div class="add">&nbsp;&nbsp;&nbsp;8 +&nbsp;&nbsp;email: z.email()</div></div></div></div>
</div>
...
<div class="panel"><div class="panel-head">~/agent-reference.local.json</div><div class="panel-body"><div class="code small"><div>{</div><div>&nbsp;&nbsp;<span class="k">"references"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"dotfiles"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"~/.dotfiles"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"Shell and editor"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;},</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"forks"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"~/code/forks"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"Upstream repos I patched"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;}</div><div>}</div></div></div></div>
</div>
...
<div class="pair">
<div class="panel"><div class="panel-head">agent-reference.json</div><div class="panel-body"><div class="code small"><div><span class="k">"references"</span>: {</div><div>&nbsp;&nbsp;<span class="k mark">"harnesses"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"How others solve this"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"references"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"pi"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"github:earendil-works/pi"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"The smallest, TypeScript"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"codex"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"github:openai/codex"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"Rust, with the sandbox"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"opencode"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"github:anomalyco/opencode"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"Tests beside each tool"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;}</div><div>}</div></div></div></div>
<div class="panel"><div class="panel-head">agent</div><div class="panel-body"><div class="sess" style="font-size:12px">
...
<div class="r"><span class="el">&#9151;</span>&nbsp;&nbsp;pi -&gt; &hellip;/earendil-works/pi/dcd461925db2</div>
<div class="r">&nbsp;&nbsp;&nbsp;codex -&gt; &hellip;/openai/codex/a4f10b27e83c</div>
<div class="r">&nbsp;&nbsp;&nbsp;opencode -&gt; &hellip;/anomalyco/opencode/7b0e5c31d4a9</div>
</div>
<div>
...
<div class="pair">
<div class="panel"><div class="panel-head">~/code/acme/web/agent-reference.json</div><div class="panel-body"><div class="code tiny"><div>{</div><div>&nbsp;&nbsp;<span class="k">"references"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"effect"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"npm:effect@4.0.0-rc.111"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"v4's own examples"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;},</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"decisions"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"./docs/decisions"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"One file per decision"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;},</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"harnesses"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"How others solve this"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"references"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"pi"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"github:earendil-works/pi"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"The smallest, TypeScript"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;}</div><div>}</div></div></div></div>
<div class="panel"><div class="panel-head">~/code/acme/web/agent-reference.local.json</div><div class="panel-body"><div class="code tiny"><div>{</div><div>&nbsp;&nbsp;<span class="k">"references"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"api"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"../api"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"Acme's API"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;},</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"notes"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"~/Documents/notes"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: <span class="s">"My running notes"</span></div><div>&nbsp;&nbsp;&nbsp;&nbsp;},</div><div>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"spike"</span>: {</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"source"</span>: <span class="s">"git@git.acme.internal:me/spike.git"</span>,</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">"description"</span>: "My scratch repo. Never</div><div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;name this one in a commit"</div><div>&nbsp;&nbsp;&nbsp;&nbsp;}</div><div>&nbsp;&nbsp;}</div><div>}</div></div></div></div>
</div>
