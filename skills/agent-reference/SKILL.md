...
- `fallback` — no matching commit was found and the repository default branch was checked out. This is **not** the published version; say so rather than treating the source as authoritative.
