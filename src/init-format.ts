...
function proposeStep(): string {
  return [
    ...
    'Give each one a description saying what the source is and whose it is, in terms that stay',
    'true; a later agent judges that against its own task. Skip what the name already says.',
